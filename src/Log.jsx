          ...
          <main style={{ paddingTop: "0.5rem" }}>
            ...
            <section style={{ marginBottom: "1.2rem" }}>
              ...
              <p className="section-subtitle">
                Capture how you’re feeling and any triggers, cravings, or wins
                from today.
              </p>
              ...
              <div className="form-field">
                ...
                <div className="mood-row">
                  <span className="mood-pill mood-pill--strong">
                    🙏 Grateful
                  </span>
            ...
            <section style={{ marginBottom: "1.4rem" }}>
              ...
              <p className="section-subtitle">
                Save key sobriety milestones so you can look back on how far
                you’ve come.
              </p>
            ...
            <section style={{ marginBottom: "1.4rem" }}>
              ...
              <p className="section-subtitle">
                Set clear goals for your recovery so Circely can help you stay
                on track.
              </p>
            ...
            <section style={{ marginBottom: "0.4rem" }}>
              ...
              <p className="section-subtitle">
                Identify the people, places, things, or dates that increase your
                risk. We’ll help remind you next time.
              </p>
              ...
              <div className="checkbox-list">
                ...
                <label className="checkbox-item">
                  <input type="checkbox" />
                  <span>
                    Send a reminder the next time this event occurs
                  </span>
                </label>
                <label className="checkbox-item">
                  <input type="checkbox" />
